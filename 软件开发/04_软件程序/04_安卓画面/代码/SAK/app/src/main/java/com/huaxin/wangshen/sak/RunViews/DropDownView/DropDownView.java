package com.huaxin.wangshen.sak.RunViews.DropDownView;
...
import com.huaxin.wangshen.sak.RunViews.DropDownView.KeyBoardTool;
import com.huaxin.wangshen.sak.RunViews.DropDownView.SizeTool;
import com.huaxin.wangshen.sak.RunViews.DropDownView.StringTool;
 ...
 */
public class DropDownView extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener {

private  Context mContext;
    private static final String TAG = "DropDownView";
    public static final String NUSELETED_SHOW_NAME = "产品模式";
    String[] items_all;
